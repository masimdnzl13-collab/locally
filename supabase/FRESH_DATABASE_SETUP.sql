...
-- kurdun (BOŞ bir veritabanı). Bu dosya repodaki 20 migration dosyasının
-- TAMAMINI, doğru kronolojik sırayla, tek dosyada birleştirir.
--
-- Projen yalnızca DURAKLATILMIŞTI ve "Restore" ile geri açtıysan bu dosyayı
-- DEĞİL, APPLY_PENDING_MIGRATIONS.sql dosyasını kullan — o proje zaten bu
-- 18 eski migration'ı içeriyor, bunu tekrar çalıştırmak hataya sebep olur.
--
