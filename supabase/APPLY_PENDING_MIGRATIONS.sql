...
--
-- BU SÜRÜMDE NE DEĞİŞTİ: kapsam TÜM 22 migration dosyasına genişletildi
...
-- adında basit bir kayıt defteri oluşturur ve TÜM 22 migration için (imza
...
-- artık aynı 22 migration'ı içeriyor, tek fark FRESH_DATABASE_SETUP.sql'in
